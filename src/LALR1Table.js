...
// FIXME: This is copy-pasted from LR1Table. Only the table calculation differs.

class LALR1Table extends Component {
  render() {
    const info = this.props.grammar.calculate('grammar.symbolInfo');
    const table = this.props.grammar.calculate('parsing.lr.lalr1_table');
